    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='work_task', to='worktime.WorkTask', verbose_name='工时任务')),
                ('task_manager', models.ManyToManyField(db_table='tb_time_and_user', related_name='mes_manager', to=settings.AUTH_USER_MODEL, verbose_name='信息审批人')),
            ],
            options={
                'verbose_name': '试验内容',
