...
class Audio(models.Model):
    ...
    status = models.ForeignKey(Status, null=True, blank=True, default=None, verbose_name="抱怨工况")
    ...
    raw_mp3 = models.CharField(max_length=100, default=None, null=True, verbose_name='报告原始数据')
    img = models.CharField(max_length=100, default=None, null=True, verbose_name='抱怨特征图')
    complain_mp3 = models.CharField(max_length=100, default=None, null=True, verbose_name='抱怨音频')
    ppt = models.CharField(max_length=100, default=None, null=True, verbose_name='分析报告')
