# -*- coding: utf-8 -*-
# Generated by Django 1.11.23 on 2020-08-04 13:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw_mp3', models.CharField(default=None, max_length=100, null=True, verbose_name='报告原始数据')),
                ('img', models.CharField(default=None, max_length=100, null=True, verbose_name='抱怨特征图')),
                ('complain_mp3', models.CharField(default=None, max_length=100, null=True, verbose_name='抱怨音频')),
                ('ppt', models.CharField(default=None, max_length=100, null=True, verbose_name='分析报告')),
            ],
            options={
                'db_table': 'tb_audio',
