...
class Calculate_Object(object):
    def __init__(self, file_name, data, channel_name, raw_time_num, raw_data_num, raw_rpm_num):
        self.A = 1
        self.order = 2
        self.overlap = 75
        self.weighting = 1
        ...
        self.raw_time = data[:, raw_time_num]
        self.raw_data = data[:, raw_data_num]
        self.raw_rpm = data[:, raw_rpm_num]
