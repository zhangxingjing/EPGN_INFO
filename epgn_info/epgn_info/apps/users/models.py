...
class Direction(models.Model):
    id = models.AutoField(primary_key=True)
    name = models.CharField(max_length=225, verbose_name="专业方向")

    class Meta:
        db_table = "tb_user_direction"
        verbose_name_plural = verbose_name = '专业方向'
...
class User(AbstractUser):
    ...
    update_files_data = models.IntegerField(default=0, verbose_name='数据上传')
    download_files_data = models.IntegerField(default=0, verbose_name='数据下载')
    ...
    direction = models.ForeignKey(Direction, null=True, blank=True, default=None, verbose_name='专业方向')
    task = models.ManyToManyField(Task, related_name="tag_article", blank=True, default=None, verbose_name='待办事项')
